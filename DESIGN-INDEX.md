...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 43397 |
| tokens aproximados de `DESIGN.md` | 511600 |
| linhas de `RATIONALE.md` | 14558 |
| tokens aproximados de `RATIONALE.md` | 354200 |
| seções numeradas | 27 |
...
| 26 | 36303–43397 | 96400 | Plano de implementação |
...
| validação e decisões | 24, 25, 26 | 33933–43397 | 131900 | freeze, Última Luz, gates e roadmap |

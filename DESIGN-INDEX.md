...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 41018 |
| tokens aproximados de `DESIGN.md` | 478200 |
| linhas de `RATIONALE.md` | 13029 |
| tokens aproximados de `RATIONALE.md` | 318200 |
| seções numeradas | 27 |
| seções terminais com evidência local | 446/464 |
| decisões | 1609 (W-001–W-1609) |
...
| decisões referenciadas por casos R0 | 274/1609 |
| decisões classificadas para design freeze | 1609/1609 (825 implementation-evidence-gap; 83 superseded; 185 source-backed-current; 508 oracle-backed-current; 8 rejected) |
| decisões com evidência legada de fonte/oráculo | 640/1609 (274 source + 415 oracle + 8 explícitas; 57 overlaps) |
...
| 26 | 35676–41018 | 72200 | Plano de implementação |
...
| validação e decisões | 24, 25, 26 | 33306–41018 | 107700 | freeze, Última Luz, gates e roadmap |

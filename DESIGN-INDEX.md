...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 41273 |
| tokens aproximados de `DESIGN.md` | 481500 |
| linhas de `RATIONALE.md` | 13236 |
| tokens aproximados de `RATIONALE.md` | 323000 |
| seções numeradas | 27 |
| seções terminais com evidência local | 451/472 |
| decisões | 1617 (W-001–W-1617) |
| famílias de viabilidade | 183 |
| slices normativos de grammar | 6 |
| requisitos de ratificação comparativa | 171 |
| casos de substituição estruturados | 171/171 |
| decisões referenciadas por casos R0 | 282/1617 |
| decisões classificadas para design freeze | 1617/1617 (825 implementation-evidence-gap; 83 superseded; 193 source-backed-current; 508 oracle-backed-current; 8 rejected) |
| decisões com evidência legada de fonte/oráculo | 648/1617 (282 source + 415 oracle + 8 explícitas; 57 overlaps) |
| decisões ainda sem classe de freeze | 0 |
| decisões com múltiplos eixos obrigatórios | 2 |
| formas R0 com baseline estática | 631 |
| surface lexemes das formas vigentes R0 | 6644 total; mediana 34; máximo 151 |
| bundles executáveis R1 | 57 |
| variantes/tarefas R1 | 162/228 |
| casos R0 promovidos a R1 | 69/171 |
...
| 26 | 35676–41273 | 75500 | Plano de implementação |

## Navegação compacta de RATIONALE

| Seção | Linhas | Tokens aproximados | Tema |
|---:|---:|---:|---|
| 1 | 15–6281 | 101700 | Evidência comparativa |
| 2 | 6282–6311 | 500 | Proveniência |
| 3 | 6312–13236 | 220700 | Ledger |
...
| validação e decisões | 24, 25, 26 | 33306–41273 | 111000 | freeze, Última Luz, gates e roadmap |

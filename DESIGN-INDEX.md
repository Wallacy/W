...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 39728 |
| tokens aproximados de `DESIGN.md` | 459100 |
| linhas de `RATIONALE.md` | 12105 |
| tokens aproximados de `RATIONALE.md` | 296900 |
| seções numeradas | 27 |
| seções terminais com evidência local | 436/439 |
| decisões | 1583 (W-001–W-1583) |
| famílias de viabilidade | 183 |
| slices normativos de grammar | 6 |
| requisitos de ratificação comparativa | 141 |
| casos de substituição estruturados | 141/141 |
| decisões referenciadas por casos R0 | 249/1583 |
| decisões classificadas para design freeze | 1583/1583 (825 implementation-evidence-gap; 82 superseded; 162 source-backed-current; 506 oracle-backed-current; 8 rejected) |
| decisões com evidência legada de fonte/oráculo | 613/1583 (249 source + 413 oracle + 8 explícitas; 57 overlaps) |
| decisões ainda sem classe de freeze | 0 |
| decisões com múltiplos eixos obrigatórios | 2 |
| formas R0 com baseline estática | 473 |
| surface lexemes das formas vigentes R0 | 5040 total; mediana 28; máximo 151 |
| bundles executáveis R1 | 57 |
| variantes/tarefas R1 | 162/228 |
| casos R0 promovidos a R1 | 69/141 |
...
| 26 | 35402–39728 | 57700 | Plano de implementação |

## Navegação compacta de RATIONALE

| Seção | Linhas | Tokens aproximados | Tema |
|---:|---:|---:|---|
| 1 | 15–6251 | 100500 | Evidência comparativa |
| 2 | 6252–6281 | 500 | Proveniência |
| 3 | 6282–12105 | 195700 | Ledger |
...
| validação e decisões | 24, 25, 26 | 33032–39728 | 93200 | freeze, Última Luz, gates e roadmap |

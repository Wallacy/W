...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 39772 |
| tokens aproximados de `DESIGN.md` | 459800 |
| linhas de `RATIONALE.md` | 12149 |
| tokens aproximados de `RATIONALE.md` | 298000 |
| seções numeradas | 27 |
| seções terminais com evidência local | 436/440 |
| decisões | 1584 (W-001–W-1584) |
| famílias de viabilidade | 183 |
| slices normativos de grammar | 6 |
| requisitos de ratificação comparativa | 142 |
| casos de substituição estruturados | 142/142 |
| decisões referenciadas por casos R0 | 250/1584 |
| decisões classificadas para design freeze | 1584/1584 (825 implementation-evidence-gap; 82 superseded; 163 source-backed-current; 506 oracle-backed-current; 8 rejected) |
| decisões com evidência legada de fonte/oráculo | 614/1584 (250 source + 413 oracle + 8 explícitas; 57 overlaps) |
| decisões ainda sem classe de freeze | 0 |
| decisões com múltiplos eixos obrigatórios | 2 |
| formas R0 com baseline estática | 478 |
| surface lexemes das formas vigentes R0 | 5133 total; mediana 28.5; máximo 151 |
| bundles executáveis R1 | 57 |
| variantes/tarefas R1 | 162/228 |
| casos R0 promovidos a R1 | 69/142 |
...
| 20 | 26613–28306 | 19000 | Compilador e bootstrap |
| 21 | 28307–30842 | 26700 | Packages, builds e releases |
| 22 | 30843–31480 | 6800 | Tooling e interface para máquinas |
| 23 | 31481–33031 | 19100 | Protocolos e pesquisas de ecossistema |
| 24 | 33032–35190 | 33600 | Design freeze e pendências |
| 25 | 35191–35401 | 1900 | Produto de referência Última Luz |
| 26 | 35402–39772 | 58400 | Plano de implementação |

## Navegação compacta de RATIONALE

| Seção | Linhas | Tokens aproximados | Tema |
|---:|---:|---:|---|
| 1 | 15–6252 | 100600 | Evidência comparativa |
| 2 | 6253–6282 | 500 | Proveniência |
| 3 | 6283–12149 | 196800 | Ledger |
...
| compiler e distribuição | 20, 21, 22, 23 | 26613–33031 | 71600 | frontend, HIR, packages, releases, tooling e protocolos |
| validação e decisões | 24, 25, 26 | 33032–39772 | 93900 | freeze, Última Luz, gates e roadmap |

...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 37876 |
| tokens aproximados de `DESIGN.md` | 435500 |
| linhas de `RATIONALE.md` | 11022 |
| tokens aproximados de `RATIONALE.md` | 270100 |
| seções numeradas | 27 |
| seções terminais com evidência local | 405/405 |
| decisões | 1550 (W-001–W-1550) |
| famílias de viabilidade | 183 |
| slices normativos de grammar | 6 |
| requisitos de ratificação comparativa | 114 |
| casos de substituição estruturados | 114/114 |
| decisões referenciadas por casos R0 | 217/1550 |
| decisões classificadas para design freeze | 1550/1550 (823 implementation-evidence-gap; 82 superseded; 131 source-backed-current; 506 oracle-backed-current; 8 rejected) |
| decisões com evidência legada de fonte/oráculo | 581/1550 (217 source + 413 oracle + 8 explícitas; 57 overlaps) |
...
| casos R0 promovidos a R1 | 69/114 |
...
| 26 | 35158–37876 | 37700 | Plano de implementação |

## Navegação compacta de RATIONALE

| Seção | Linhas | Tokens aproximados | Tema |
|---:|---:|---:|---|
| 1 | 15–6215 | 99500 | Evidência comparativa |
| 2 | 6216–6245 | 500 | Proveniência |
| 3 | 6246–11022 | 169900 | Ledger |
...
| validação e decisões | 24, 25, 26 | 32788–37876 | 73200 | freeze, Última Luz, gates e roadmap |

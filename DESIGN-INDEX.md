...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 40341 |
| tokens aproximados de `DESIGN.md` | 467900 |
| linhas de `RATIONALE.md` | 12589 |
| tokens aproximados de `RATIONALE.md` | 308300 |
| seções numeradas | 27 |
| seções terminais com evidência local | 445/453 |
| decisões | 1597 (W-001–W-1597) |
| famílias de viabilidade | 183 |
| slices normativos de grammar | 6 |
| requisitos de ratificação comparativa | 153 |
| casos de substituição estruturados | 153/153 |
| decisões referenciadas por casos R0 | 263/1597 |
| decisões classificadas para design freeze | 1597/1597 (825 implementation-evidence-gap; 83 superseded; 175 source-backed-current; 506 oracle-backed-current; 8 rejected) |
| decisões com evidência legada de fonte/oráculo | 627/1597 (263 source + 413 oracle + 8 explícitas; 57 overlaps) |
| decisões ainda sem classe de freeze | 0 |
| decisões com múltiplos eixos obrigatórios | 2 |
| formas R0 com baseline estática | 532 |
| surface lexemes das formas vigentes R0 | 5658 total; mediana 31; máximo 151 |
| bundles executáveis R1 | 57 |
| variantes/tarefas R1 | 162/228 |
| casos R0 promovidos a R1 | 69/153 |
...
| 26 | 35418–40341 | 66200 | Plano de implementação |

## Navegação compacta de RATIONALE

| Seção | Linhas | Tokens aproximados | Tema |
|---:|---:|---:|---|
| 1 | 15–6263 | 101000 | Evidência comparativa |
| 2 | 6264–6293 | 500 | Proveniência |
| 3 | 6294–12589 | 206800 | Ledger |
...
| validação e decisões | 24, 25, 26 | 33048–40341 | 101700 | freeze, Última Luz, gates e roadmap |

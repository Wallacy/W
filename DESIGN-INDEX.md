...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 39825 |
| tokens aproximados de `DESIGN.md` | 460700 |
| linhas de `RATIONALE.md` | 12207 |
| tokens aproximados de `RATIONALE.md` | 299300 |
| seções numeradas | 27 |
| seções terminais com evidência local | 436/441 |
| decisões | 1585 (W-001–W-1585) |
| famílias de viabilidade | 183 |
| slices normativos de grammar | 6 |
| requisitos de ratificação comparativa | 143 |
| casos de substituição estruturados | 143/143 |
| decisões referenciadas por casos R0 | 251/1585 |
| decisões classificadas para design freeze | 1585/1585 (825 implementation-evidence-gap; 82 superseded; 164 source-backed-current; 506 oracle-backed-current; 8 rejected) |
| decisões com evidência legada de fonte/oráculo | 615/1585 (251 source + 413 oracle + 8 explícitas; 57 overlaps) |
| decisões ainda sem classe de freeze | 0 |
| decisões com múltiplos eixos obrigatórios | 2 |
| formas R0 com baseline estática | 483 |
| surface lexemes das formas vigentes R0 | 5187 total; mediana 29; máximo 151 |
| bundles executáveis R1 | 57 |
| variantes/tarefas R1 | 162/228 |
| casos R0 promovidos a R1 | 69/143 |
...
| 26 | 35402–39825 | 59300 | Plano de implementação |

## Navegação compacta de RATIONALE

| Seção | Linhas | Tokens aproximados | Tema |
|---:|---:|---:|---|
| 1 | 15–6253 | 100600 | Evidência comparativa |
| 2 | 6254–6283 | 500 | Proveniência |
| 3 | 6284–12207 | 198100 | Ledger |
...
| validação e decisões | 24, 25, 26 | 33032–39825 | 94800 | freeze, Última Luz, gates e roadmap |

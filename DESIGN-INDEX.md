...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 40478 |
| tokens aproximados de `DESIGN.md` | 469900 |
| linhas de `RATIONALE.md` | 12742 |
| tokens aproximados de `RATIONALE.md` | 311900 |
| seções numeradas | 27 |
...
| surface lexemes das formas vigentes R0 | 5917 total; mediana 31; máximo 151 |
...
| 26 | 35418–40478 | 68200 | Plano de implementação |
...
| validação e decisões | 24, 25, 26 | 33048–40478 | 103700 | freeze, Última Luz, gates e roadmap |

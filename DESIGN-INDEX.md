...
| linhas de `RATIONALE.md` | 5971 |
| tokens aproximados de `RATIONALE.md` | 153300 |
| seções numeradas | 27 |
| seções terminais com evidência local | 339/339 |
| decisões | 1391 (W-001–W-1391) |
...
| decisões referenciadas por casos R0 | 170/1391 |
| decisões classificadas para design freeze | 547/1391 (170 source + 432 oracle + 8 explícitas; 63 overlaps) |
| decisões ainda sem classe de freeze | 844 |
...
| bundles executáveis R1 | 41 |
| variantes/tarefas R1 | 112/164 |
...
| Seção | Linhas | Tokens aproximados | Tema |
|---:|---:|---:|---|
| 1 | 14–4532 | 69600 | Evidência comparativa |
| 2 | 4533–4563 | 500 | Proveniência |
| 3 | 4564–5971 | 83200 | Ledger |

...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 39751 |
| tokens aproximados de `DESIGN.md` | 459500 |
| linhas de `RATIONALE.md` | 12130 |
| tokens aproximados de `RATIONALE.md` | 297600 |
| seções numeradas | 27 |
...
| 26 | 35402–39751 | 58000 | Plano de implementação |
...
| validação e decisões | 24, 25, 26 | 33032–39751 | 93500 | freeze, Última Luz, gates e roadmap |

...
| Métrica | Valor |
|---|---:|
| linhas de `DESIGN.md` | 41317 |
| tokens aproximados de `DESIGN.md` | 482100 |
| linhas de `RATIONALE.md` | 13265 |
| tokens aproximados de `RATIONALE.md` | 323700 |
| seções numeradas | 27 |
| seções terminais com evidência local | 452/473 |
| decisões | 1618 (W-001–W-1618) |
| famílias de viabilidade | 183 |
| slices normativos de grammar | 6 |
| requisitos de ratificação comparativa | 172 |
| casos de substituição estruturados | 172/172 |
| decisões referenciadas por casos R0 | 283/1618 |
| decisões classificadas para design freeze | 1618/1618 (825 implementation-evidence-gap; 83 superseded; 194 source-backed-current; 508 oracle-backed-current; 8 rejected) |
| decisões com evidência legada de fonte/oráculo | 649/1618 (283 source + 415 oracle + 8 explícitas; 57 overlaps) |
| decisões ainda sem classe de freeze | 0 |
| decisões com múltiplos eixos obrigatórios | 2 |
| formas R0 com baseline estática | 636 |
| surface lexemes das formas vigentes R0 | 6687 total; mediana 34; máximo 151 |
| bundles executáveis R1 | 57 |
| variantes/tarefas R1 | 162/228 |
| casos R0 promovidos a R1 | 69/172 |
...
| 26 | 35676–41317 | 76100 | Plano de implementação |

## Navegação compacta de RATIONALE

| Seção | Linhas | Tokens aproximados | Tema |
|---:|---:|---:|---|
| 1 | 15–6282 | 101800 | Evidência comparativa |
| 2 | 6283–6312 | 500 | Proveniência |
| 3 | 6313–13265 | 221300 | Ledger |
...
| validação e decisões | 24, 25, 26 | 33306–41317 | 111600 | freeze, Última Luz, gates e roadmap |

...
enum {
  ...
  GATE_HIR_RECEIPT = W_SEED_HIR0_MAX_RECEIPT_BYTES,
};
...
typedef struct {
  ...
  w_seed_hir0_block_argument hir_block_arguments[GATE_HIR_RECORDS];
  w_seed_hir0_edge_argument hir_edge_arguments[GATE_HIR_RECORDS];
...
static bool lower_hir(gate_fixture *fixture) {
  ...
  fixture->hir_output = (w_seed_hir0_output){
      ...
      .block_argument_capacity = GATE_HIR_RECORDS,
      .edge_arguments = fixture->hir_edge_arguments,
      .edge_argument_capacity = GATE_HIR_RECORDS,
...
static bool read_fixture(gate_fixture *fixture, const char *path) {
  ...
  fixture->document = (w_seed_frontend_document){
      ...
      .module_id = (w_seed_frontend_text){"hlo1-fixture", 12u},
      .local_module_name = (w_seed_frontend_text){"hlo1-fixture", 12u},

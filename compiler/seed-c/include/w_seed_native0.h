...
#define W_SEED_NATIVE0_SCHEMA_VERSION "w-seed-native0-12"
...
enum {
  ...
  W_SEED_NATIVE0_TYPES = 64,
  W_SEED_NATIVE0_FUNCTIONS = 16,
  W_SEED_NATIVE0_PARAMETERS = 32,
  ...
  W_SEED_NATIVE0_HIR_ENUM_SUBSET_MEMBERS =
      W_SEED_NATIVE0_ENUM_SUBSET_MEMBERS,
  W_SEED_NATIVE0_HIR_ENUM_PAYLOADS = W_SEED_NATIVE0_ARGUMENTS,
...
_Static_assert(W_SEED_NATIVE0_STATEMENTS <= UINT32_MAX &&
                   ...
                   W_SEED_NATIVE0_HIR_ENUM_CASE_PARAMETERS <= UINT32_MAX &&
                   W_SEED_NATIVE0_HIR_ENUM_SUBSET_MEMBERS <= UINT32_MAX &&
                   W_SEED_NATIVE0_HIR_ENUM_PAYLOADS <= UINT32_MAX &&
...
typedef struct {
  ...
  w_seed_hir0_enum_case_parameter
      hir_enum_case_parameters[W_SEED_NATIVE0_HIR_ENUM_CASE_PARAMETERS];
  w_seed_hir0_enum_subset_member
      hir_enum_subset_members[W_SEED_NATIVE0_HIR_ENUM_SUBSET_MEMBERS];
  w_seed_hir0_enum_payload
      hir_enum_payloads[W_SEED_NATIVE0_HIR_ENUM_PAYLOADS];

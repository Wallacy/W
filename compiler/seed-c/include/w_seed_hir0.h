 ...
 * allocate. */
#define W_SEED_HIR0_SCHEMA_VERSION "w-seed-hir0-88"
...
typedef struct {
  ...
  uint32_t enum_index;
  uint32_t enum_case_index;
  /* Present only for VALUE_INTEGER_WIDEN or an explicit integer
   * conversion; destination is always type_index. */

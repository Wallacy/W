...
typedef enum {
  ...
  W_SEED_CST_PIPELINE_EXPRESSION,
  W_SEED_CST_COMMIT_STATEMENT,
  W_SEED_CST_BORROW_CLAUSE,
  W_SEED_CST_BORROW_PAIR,
  W_SEED_CST_SLOT_REF,
  W_SEED_CST_LOCK_EXPRESSION,
  /* Append-only generic, contract, and switch owners. */
  ...
  W_SEED_CST_TUPLE_TYPE,
  W_SEED_CST_TUPLE_EXPRESSION,
  W_SEED_CST_SPAWN_STATEMENT,
  /* Append-only callable and closure owners. */
  W_SEED_CST_FUNCTION_TYPE,
  W_SEED_CST_FUNCTION_TYPE_PARAMETERS,
  W_SEED_CST_CLOSURE_EXPRESSION,
  W_SEED_CST_CLOSURE_PARAMETERS,
  ...
  /* Append-only module-header reusable contract relation call owner. */
  W_SEED_CST_MODULE_CONTRACT_RELATION,
} w_seed_cst_kind;

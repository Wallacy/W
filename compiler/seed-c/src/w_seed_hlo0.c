...
static bool input_aliases_outputs(const w_seed_hlo0_input *input,
  ...
  const hlo0_input_range input_ranges[] = {
      ...
      {input->program->enums, input->program->enum_capacity,
       sizeof(*input->program->enums)},
      {input->program->enum_cases, input->program->enum_case_capacity,
       sizeof(*input->program->enum_cases)},
      {input->program->enum_case_parameters,
       input->program->enum_case_parameter_capacity,
       sizeof(*input->program->enum_case_parameters)},
      {input->program->enum_payloads, input->program->enum_payload_capacity,
       sizeof(*input->program->enum_payloads)},
      {input->program->switch_captures, input->program->switch_capture_capacity,
       sizeof(*input->program->switch_captures)},
      ...
      {input->program->block_arguments,
       input->program->block_argument_capacity,
       sizeof(*input->program->block_arguments)},
      {input->program->edge_arguments, input->program->edge_argument_capacity,
       sizeof(*input->program->edge_arguments)},
      {input->program->switch_edges, input->program->switch_edge_capacity,
       sizeof(*input->program->switch_edges)},
      ...
      {input->program->interpolation_segments,
       input->program->interpolation_segment_capacity,
       sizeof(*input->program->interpolation_segments)},
      ...
      {input->program->external_modules,
       input->program->external_module_capacity,
       sizeof(*input->program->external_modules)},
      {input->program->external_symbols,
       input->program->external_symbol_capacity,
       sizeof(*input->program->external_symbols)},

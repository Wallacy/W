...
static void configure_frontend_storage(w_seed_native0_storage *storage) {
  ...
  storage->output = (w_seed_frontend_output){
      ...
      .tuple_components = storage->tuple_components,
      .tuple_component_capacity = W_SEED_NATIVE0_TUPLE_COMPONENTS,
      .tuple_elements = storage->tuple_elements,
      .tuple_element_capacity = W_SEED_NATIVE0_TUPLE_ELEMENTS,
...
static w_seed_native0_status lower_hir(
  ...
  storage->hir_output = (w_seed_hir0_output){
      ...
      .enums = storage->hir_enums,
      .enum_capacity = W_SEED_NATIVE0_HIR_ENUMS,
      .enum_cases = storage->hir_enum_cases,
      .enum_case_capacity = W_SEED_NATIVE0_HIR_ENUM_CASES,
      .enum_case_parameters = storage->hir_enum_case_parameters,
      .enum_case_parameter_capacity =
          W_SEED_NATIVE0_HIR_ENUM_CASE_PARAMETERS,
      .enum_subset_members = storage->hir_enum_subset_members,
      .enum_subset_member_capacity = W_SEED_NATIVE0_HIR_ENUM_SUBSET_MEMBERS,
      ...
      .edge_argument_capacity = W_SEED_NATIVE0_HIR_EDGE_ARGUMENTS,
      .switch_edges = storage->hir_switch_edges,
      .switch_edge_capacity = W_SEED_NATIVE0_HIR_SWITCH_EDGES,
      .switch_captures = storage->hir_switch_captures,
      .switch_capture_capacity = W_SEED_NATIVE0_HIR_SWITCH_CAPTURES,

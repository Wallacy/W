...
const routes = new Map<string, { file: string; type: string }>([
  ...
  ["/examples/restaurant/oracle.w", { file: "../examples/restaurant/oracle.w", type: "text/plain; charset=utf-8" }],
  ["/examples/restaurant/hardware.w", { file: "../examples/restaurant/hardware.w", type: "text/plain; charset=utf-8" }],
  ["/examples/restaurant/restaurant.w", { file: "../examples/restaurant/restaurant.w", type: "text/plain; charset=utf-8" }],

...
const routes = new Map<string, { file: string; type: string }>([
  ...
  ["/reference/last-light/README.md", { file: "../reference/last-light/README.md", type: "text/markdown; charset=utf-8" }],
  ["/reference/last-light/domain.w", { file: "../reference/last-light/domain.w", type: "text/plain; charset=utf-8" }],
  ["/reference/last-light/units.w", { file: "../reference/last-light/units.w", type: "text/plain; charset=utf-8" }],
  ["/reference/last-light/oracle.w", { file: "../reference/last-light/oracle.w", type: "text/plain; charset=utf-8" }],
  ["/reference/last-light/hardware.w", { file: "../reference/last-light/hardware.w", type: "text/plain; charset=utf-8" }],
  ["/reference/last-light/restaurant.w", { file: "../reference/last-light/restaurant.w", type: "text/plain; charset=utf-8" }],
  ["/reference/last-light/app.w", { file: "../reference/last-light/app.w", type: "text/plain; charset=utf-8" }],
  ["/docs/README.md", { file: "../README.md", type: "text/markdown; charset=utf-8" }],
  ["/docs/DESIGN.md", { file: "../DESIGN.md", type: "text/markdown; charset=utf-8" }],
]);

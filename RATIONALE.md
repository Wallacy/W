...
| ergonomia com evidência | 65–72% | R0 cobre 70/70, R0S mede a superfície derivada por script e R1 possui 24 bundles contrabalanceados do Última Luz que promovem 37/70 casos R0; participantes e modelos ainda não foram executados |
...
| W-886 | corpus R1 ampliado | 24 bundles, 59 variantes e 96 tarefas cobrem os domínios R1 atuais com source base, inputs, digests e oracle; 37/70 casos R0 foram promovidos | extrapolar R0; variante sem contexto; outcome não fixado; chamar host oracle de execução W |
...
| W-920 | cobertura de promoção R1 | índice e checker contam IDs R0 únicos ligados a bundles; 37/70 mede planejamento, não evidência humana, de modelo ou runtime | contar referências duplicadas; dividir bundles por requisitos; chamar promoção de ratificação; esconder o denominador |

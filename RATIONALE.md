...
acrescenta o core C11 bounded de aquisição/revalidação para requests explícitos
e o adapter Linux real ancorado em `openat2`, com stub fail-closed fora de
Linux. CHK6 acrescenta um driver C11 interno caller-owned de discovery local
...
compilador C11 → execução`, incluindo o witness Restaurant em comentário,

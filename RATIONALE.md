...
cross-target continuam gaps. A proveniência de capacity preservada pelo parser
é evidência interna e não cria mapping D0 público. CHK1 ainda expõe `w check`
somente no perfil closed-single-source.

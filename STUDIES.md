...
| `R1-call-label-order` | Money initializer labels at the Last Light restaurant — `design-oracle-input` | [`tooling/studies/r1-call-label-order`](./tooling/studies/r1-call-label-order/) | `—` | `bun run check:study-bundles` |

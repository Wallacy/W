...
| `PKG1` | Package identity split and atomic build-root transactions — `design-oracle-input` | [`tooling/studies/pkg1-project-transaction`](./tooling/studies/pkg1-project-transaction/) | `—` | `bun tooling/command-runner.mjs --command check:pkg1` |
...
| `WGFX0` | First-party scene and graphics library inspired by proven web 3D ergonomics — `design-oracle-input` | [`tooling/studies/wgfx0-first-party-scene-graphics`](./tooling/studies/wgfx0-first-party-scene-graphics/) | `—` | `bun tooling/command-runner.mjs --command check:study-bundles` |

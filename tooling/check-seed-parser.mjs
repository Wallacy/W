...
async function main() {
  ...
  try {
    ...
    if (genericsParsed.nodes.filter((node) => node.kind === CST.ALIAS_DECLARATION).length !== 12 ||
        genericsParsed.nodes.filter((node) => node.kind === CST.CONTRACT_ENVELOPE).length !== 12) {

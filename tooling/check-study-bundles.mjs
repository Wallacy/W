...
for (const bundleFile of bundleFiles) {
  ...
  for (const [index, variant] of bundle.variants.entries()) {
    ...
    if (!["selected", "alternative", "current-design-evidence-gap", "future-reopen-candidate", "research-candidate", "historical-candidate", "rejected-witness"].includes(variant.role)) {
      errors.push(`${variantLocation}.role must be selected, alternative, current-design-evidence-gap, future-reopen-candidate, research-candidate, historical-candidate, or rejected-witness.`);
    }

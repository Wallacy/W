...
const currentTargetScope = "w-seed-mlir0-9-scalar-function-results";
const currentRuntimeVersion = "w-seed-mlir0-9";
const currentArtifactScope = "scalar-function-results";

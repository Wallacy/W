...
| `studies/*/bundle.json` + checker | 22 bundles R1, 54 variantes e 88 tarefas; 34/70 casos R0 são promovidos | parse e oracle host não equivalem a compilar ou executar W |

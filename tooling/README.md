...
| `std-api-contracts.json` + checker SDK0 | perfis cobrem 105 exports em 13 módulos, com 104 draft-ready e um bloqueado, 36 superfícies qualificadas, nove requisitos adversariais e sete carriers | catálogo e snapshot são projeções; dois carriers e cinco requisitos de referência não possuem draft; os quatro providers executáveis catalogados estão missing |

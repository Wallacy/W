...
| `std-api-contracts.json` + checker SDK0 | perfis cobrem 328 exports em 23 módulos, 84 superfícies qualificadas, 26/26 requisitos contratados e 2/8 carriers missing (Blob/FormData) | catálogo e snapshot são projeções; módulos catalogados são drafts e seus 17/17 providers intrinsics continuam missing; bounds determinísticos entram na recipe key; o host publica o action-result pós-handler |

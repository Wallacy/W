...
O estado atual é `91 source-backed-current`, `478 oracle-backed-current`, `3
research-gated`, `813 implementation-evidence-gap`, `57 superseded` e `8
rejected` (1450/1450). A lacuna histórica de 916 fica distribuída em 65
...
| `design-freeze-classification.json` + `check-design-freeze-audit.mjs` | registro versionado e explícito dos 1450 IDs, com uma categoria fechada, claim do ledger, authority ref, digests, casos de fonte/oráculo e stop condition; preserva a cobertura legada 170 source, 408 oracle, 8 explícitas e 52 overlaps; PRC0 e ASIC0 promovem gates oracle-backed-current, W-1354 é superseded por W-1437 e W-1448–W-1450 permanecem implementation-evidence-gap | auditoria de design; fonte/oráculo host não são compiler, runtime ou provider |
...
| `studies/*/bundle.json` + checker | 54 bundles R1, 154 variantes e 216 tarefas; base R1 51/148/204/69/75, agregados R1C0 52/150/208/69/75, PRC0 reuse-only 53/152/212 e ASIC0 reuse-only 54/154/216 | parse e oracle host não equivalem a compilar ou executar W |
...
O checker deriva 54 bundles, 154 variantes, 216 tasks e 69/75 casos R0
promovidos (ASIC0 acrescenta um bundle reuse-only sem payloads copiados). O conjunto contém 101 variantes `.w` parseadas e 30 witnesses

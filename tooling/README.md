...
| `studies/*/bundle.json` + checker | 23 bundles R1, 57 variantes e 92 tarefas; 35/70 casos R0 são promovidos | parse e oracle host não equivalem a compilar ou executar W |

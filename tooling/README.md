...
| `design-freeze-audit.json` + checker | combina eixos source, oracle e disposition explícita; 439/1267 decisões estão classificadas (130 source, 349 oracle e 8 explícitas), dois contratos exigem múltiplos eixos e 48 overlaps não inflam a cobertura | worklist do freeze; não transforma cobertura parcial em aprovação |

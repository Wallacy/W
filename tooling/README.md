...
| `formatter-cases.json` + checker | 28 pares input/output CST-equivalentes e snapshots de `w fmt --check`; os pares allocator cobrem bloco anônimo, call contextual e override nomeado; o par foreign formata a assinatura e preserva cada byte do body opaco | oracle de design; formatter ainda não existe |

...
| `std-api-contracts.json` + checker SDK0 | perfis cobrem 74 exports, com 72 draft-ready e dois bloqueados, 29 superfícies qualificadas, nove requisitos adversariais e sete carriers | catálogo e snapshot são projeções; cinco carriers e seis requisitos de referência não possuem draft; o único provider executável catalogado também está missing |

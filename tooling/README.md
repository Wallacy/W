...
| `std-api-contracts.json` + checker SDK0 | perfis cobrem 75 exports em 11 módulos, com 73 draft-ready e dois bloqueados, 31 superfícies qualificadas, nove requisitos adversariais e sete carriers | catálogo e snapshot são projeções; quatro carriers e seis requisitos de referência não possuem draft; os dois providers executáveis catalogados estão missing |

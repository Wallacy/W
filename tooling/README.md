...
| `design-freeze-audit.json` + checker | combina eixos source, oracle e disposition explícita; 361/1176 decisões estão classificadas (123 source, 274 oracle e 8 explícitas), dois contratos exigem múltiplos eixos e 44 overlaps não inflam a cobertura | worklist do freeze; não transforma cobertura parcial em aprovação |

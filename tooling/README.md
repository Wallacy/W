...
| `studies/*/bundle.json` + checker | 24 bundles R1, 59 variantes e 96 tarefas; 37/70 casos R0 são promovidos | parse e oracle host não equivalem a compilar ou executar W |

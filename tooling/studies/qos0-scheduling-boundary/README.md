...
> Historical W-1483 evidence. Current task placement uses the W-1511
> `pipeline<tasks: ...>` mode. Rejected cases remain adversarial evidence and
> do not define a source API.

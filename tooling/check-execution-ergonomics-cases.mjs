...
const requiredIds = new Set([
  ...
  "EE-POS-label-around-anchor-global-reorder",
  "EE-POS-label-skip-optional-anchor",
  "EE-NEG-label-required-anchor-missing",

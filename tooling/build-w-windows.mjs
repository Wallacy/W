...
export const SMOKE_CASES = Object.freeze([
  ...
  Object.freeze({
    ...
    fixture: "compiler/seed-c/fixtures/restaurant-uint-rotated-left.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
  ...
  Object.freeze({
    id: "restaurant-uint-count-ones",
    fixture: "compiler/seed-c/fixtures/restaurant-uint-count-ones.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
  ...
  Object.freeze({
    id: "restaurant-uint-leading-zeros",
    fixture: "compiler/seed-c/fixtures/restaurant-uint-leading-zeros.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
  ...
  Object.freeze({
    id: "restaurant-uint-reversed-bytes",
    fixture: "compiler/seed-c/fixtures/restaurant-uint-reversed-bytes.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "restaurant-uint-reversed-bytes.w"),
    expectedStdout: "Bytes 17279655951921914625\n",
  }),
  Object.freeze({
    id: "restaurant-uint-overflowing-add",
    fixture: "compiler/seed-c/fixtures/restaurant-uint-overflowing-add.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "restaurant-uint-overflowing-add.w"),
  ...
  Object.freeze({
    id: "restaurant-uint-overflowing-family",
    fixture: "compiler/seed-c/fixtures/restaurant-uint-overflowing-family.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
  ...
  Object.freeze({
    id: "restaurant-uint-saturating-multiply",
    fixture: "compiler/seed-c/fixtures/restaurant-uint-saturating-multiply.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",

...
export const SMOKE_CASES = Object.freeze([
  ...
  Object.freeze({
    id: "if",
    fixture: "compiler/seed-c/fixtures/if.w",
    absoluteFixture: resolve(seedDirectory, "fixtures", "if.w"),
    expectedStdout: "Kitchen open\nAfter service\nKitchen closed\nAfter service\n",
  }),
  Object.freeze({
    id: "nested-if",
    fixture: "compiler/seed-c/fixtures/nested-if.w",
    absoluteFixture: resolve(seedDirectory, "fixtures", "nested-if.w"),
    expectedStdout:
      "Restaurant open\nKitchen ready\nOpen branch joined\nPost-join service\n" +
      "Restaurant open\nKitchen closed\nOpen branch joined\nPost-join service\n" +
  ...
  Object.freeze({
    id: "mutation",
    fixture: "compiler/seed-c/fixtures/mutation.w",
    absoluteFixture: resolve(seedDirectory, "fixtures", "mutation.w"),
    expectedStdout: "Open 6\n",
  }),
  Object.freeze({
    id: "integer-wrapping",
    fixture: "compiler/seed-c/fixtures/integer-wrapping.w",
  ...
  Object.freeze({
    id: "uint-rotated-left",
    fixture: "compiler/seed-c/fixtures/uint-rotated-left.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-rotated-left.w"),
    expectedStdout: "Rotated 3\n",
  }),
  Object.freeze({
    id: "uint-rotated-right",
    fixture: "compiler/seed-c/fixtures/uint-rotated-right.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-rotated-right.w"),
    expectedStdout: "Rotated 9223372036854775809\n",
  }),
  Object.freeze({
    id: "uint-count-ones",
    fixture: "compiler/seed-c/fixtures/uint-count-ones.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-count-ones.w"),
  ...
  Object.freeze({
    id: "uint-count-zeros",
    fixture: "compiler/seed-c/fixtures/uint-count-zeros.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-count-zeros.w"),
    expectedStdout: "Zeros 32\n",
  }),
  Object.freeze({
    id: "uint-leading-zeros",
    fixture: "compiler/seed-c/fixtures/uint-leading-zeros.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-leading-zeros.w"),
    expectedStdout: "Leading 56/64\n",
  }),
  Object.freeze({
    id: "uint-trailing-zeros",
    fixture: "compiler/seed-c/fixtures/uint-trailing-zeros.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-trailing-zeros.w"),
    expectedStdout: "Trailing 12/64\n",
  }),
  Object.freeze({
    id: "uint-reversed-bits",
    fixture: "compiler/seed-c/fixtures/uint-reversed-bits.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-reversed-bits.w"),
    expectedStdout: "Bits 17848844570815808640\n",
  }),
  Object.freeze({
    id: "uint-reversed-bytes",
    fixture: "compiler/seed-c/fixtures/uint-reversed-bytes.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-reversed-bytes.w"),
    expectedStdout: "Bytes 17279655951921914625\n",
  }),
  Object.freeze({
    id: "uint-overflowing-add",
    fixture: "compiler/seed-c/fixtures/uint-overflowing-add.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-overflowing-add.w"),
    expectedStdout: "Overflowing 0/true/11/false\n",
  }),
  Object.freeze({
    id: "uint-overflowing-power",
    fixture: "compiler/seed-c/fixtures/uint-overflowing-power.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-overflowing-power.w"),
    expectedStdout:
      "Overflowing power 9223372036854775808/false; 0/true; 1/true; " +
      "1/false\n",
  }),
  Object.freeze({
    id: "uint-overflowing-family",
    fixture: "compiler/seed-c/fixtures/uint-overflowing-family.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-overflowing-family.w"),
    expectedStdout:
  ...
  Object.freeze({
    id: "uint-saturating-add",
    fixture: "compiler/seed-c/fixtures/uint-saturating-add.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-saturating-add.w"),
    expectedStdout: "Saturated 18446744073709551615/11\n",
  }),
  Object.freeze({
    id: "uint-saturating-subtract",
    fixture: "compiler/seed-c/fixtures/uint-saturating-subtract.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-saturating-subtract.w"),
    expectedStdout: "Saturated subtract 0/10\n",
  }),
  Object.freeze({
    id: "uint-saturating-multiply",
    fixture: "compiler/seed-c/fixtures/uint-saturating-multiply.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-saturating-multiply.w"),
    expectedStdout: "Saturated multiply 18446744073709551615/42\n",
  }),
  Object.freeze({
    id: "uint-saturating-policy",
    fixture: "compiler/seed-c/fixtures/uint-saturating-policy.w",
    absoluteFixture: resolve(seedDirectory, "fixtures",
      "uint-saturating-policy.w"),
    expectedStdout:

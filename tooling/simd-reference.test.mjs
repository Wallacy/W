...
describe("SIMD1 host oracle", () => {
  ...
  test("source and contract snippets are present", () => {
    const required = [
      ...
      [sources.cheatsheet, "Numeric policies and bit primitives"],
      [sources.cheatsheet, "Units, matrices, tensors, and SIMD"],
      ...
      [sources.syntaxCoverage, "../../CHEATSHEET.md#operators-and-pipe-forward"],
      [sources.syntaxCoverage, "../../CHEATSHEET.md#numeric-policies-and-bit-primitives"],

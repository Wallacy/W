...
| Workload | Language | Target | Artifact | Compile | Run | Peak RSS | CPU |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| hello | c | Windows x64 / MinGW | 19456 B (19.0 KiB) | 209.0802 ms | 22.1156 ms | 4669440 B (4.45 MiB) | — |
...
| process-entry | c | Windows x64 / MinGW | 19456 B (19.0 KiB) | 282.3706 ms | 17.5777 ms | 5337088 B (5.09 MiB) | — |
...
| process-handler-lifecycle | w | Windows x64 / MinGW | 20992 B (20.5 KiB) | 1.1450499 s | 17.7071 ms | 5324800 B (5.08 MiB) | 15.625 ms |

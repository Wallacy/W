...
| restaurant-numeric-widening | public-end-to-end | [w](../compiler/seed-c/fixtures/restaurant-numeric-widening.w), [c](./executable/restaurant_numeric_widening.c), [rust](./executable/restaurant_numeric_widening.rs) | source-backed | not-performance-ready |
| restaurant-integer-truncating-bits | public-end-to-end | [w](../compiler/seed-c/fixtures/restaurant-integer-truncating-bits.w), [c](./executable/restaurant_integer_truncating_bits.c), [rust](./executable/restaurant_integer_truncating_bits.rs) | source-backed | not-performance-ready |
| restaurant-integer-saturating-conversion | public-end-to-end | [w](../compiler/seed-c/fixtures/restaurant-integer-saturating-conversion.w), [c](./executable/restaurant_integer_saturating_conversion.c), [rust](./executable/restaurant_integer_saturating_conversion.rs) | source-backed | not-performance-ready |
...
| fixed-integer-bit-primitives | public-end-to-end | [w](../compiler/seed-c/fixtures/fixed-integer-bit-primitives.w), [c](./executable/fixed_integer_bit_primitives.c), [rust](./executable/fixed_integer_bit_primitives.rs) | source-backed | not-performance-ready |
...
| fixed-integer-exact-runtime | public-end-to-end | [w](../compiler/seed-c/fixtures/process-integer-exact-runtime.w), [c](./executable/process_integer_exact_runtime.c), [rust](./executable/process_integer_exact_runtime.rs) | source-backed | not-performance-ready |

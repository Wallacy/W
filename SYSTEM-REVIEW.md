...
| 7 | W-1561 native loop completion — closed | P2 / L | The source-backed four-block verified-HIR natural loop now reaches `scf.while`, explicit SCF-to-CF/CF-to-LLVM conversion, and public Linux/WSL native execution; the exact-output oracle agrees, and source-variable stack cells, textual lowering, host-C fallback, and expected-output shortcuts are absent |
...
| 13 | Cross-target distribution and modern MLIR witness | P2 / L | W-1561 supplies the bounded verified-HIR -> structured-MLIR witness; complete W-1533/W-1534 and one additional real host-to-target edge with SDK/ABI proof, target execution and complete size receipt; no W-dialect, provider/runtime or performance claim beyond evidence |
